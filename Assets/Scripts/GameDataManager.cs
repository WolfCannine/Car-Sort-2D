...
public class GameDataManager : MonoBehaviour
{
    ...
    private void Load()
    {
        ...
        gameData.gems = gameDataFromPlayerPrefs.gems;
        ...
        gameData.carBuy = gameDataFromPlayerPrefs.carBuy;
        gameData.themeBuy = gameDataFromPlayerPrefs.themeBuy;
        gameData.isSoundOn = gameDataFromPlayerPrefs.isSoundOn;
        gameData.isMusicOn = gameDataFromPlayerPrefs.isMusicOn;
        gameData.removeADs = gameDataFromPlayerPrefs.removeADs;
        gameData.unlockedAllLevel = gameDataFromPlayerPrefs.unlockedAllLevel;
    }
}
